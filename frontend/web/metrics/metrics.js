...
function getMetrics() {
  ...
  return (async () => {
    return await Promise.all([getFPJSLibDataPromise(), detectApp.getUserApps(), isPrivateMode(), getOpenPorts()]).then(values => {
      let Metrics = {};
